...
for m=[1 4 6 8]
    for n=8
       ...
       save(['InvLoadEstimation_Test_Results\State Matrices\Shaker Table Tests\New Tests Holdout Load Cases 1-8\RMS_Accel_Param_less_smoothing_Matrices_all_3_34Hz',num2str([m n]),'.mat'],"Ar","Br","Cr","Er","H_pred","min_value","min_index","bf")
       ...
       saveas(gcf,['Input_Estimation Plots/Shaker Table Tests/New Tests Holdout Load Cases 1-8/RMS_Accel_less_smoothing_Parameter_all_3_34Hz(Excluded,Total) = ', num2str([m n]),'.fig']);
       saveas(gcf,['Input_Estimation Plots/Shaker Table Tests/New Tests Holdout Load Cases 1-8/RMS_Accel_less_smoothing_Parameter_all_3_34Hz(Excluded,Total) = ', num2str([m n]),'.png']);
