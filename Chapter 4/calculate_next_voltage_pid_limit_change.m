function [next_voltage,P_term,I_term,D_term,pid_correction] = calculate_next_voltage_pid_limit_change(desired_force, measured_force, current_voltage, dt,kp,ki,kd)
    ...
    pid_correction = clip(pid_correction,-0.25,0.25);
