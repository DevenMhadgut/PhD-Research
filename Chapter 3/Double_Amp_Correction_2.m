...
% [freqp,ForcePC_amp0_06_noampcorrR2]=GetPointData('InvLoadEstimation_Test_Results/Corrected_After_Reattachment/Single Corrected/scan_2_0.06V.svd','FFT','Ref2','Force','Real & Imag.',3,0)
% [freqp,ForcePC_amp0_07_noampcorrR2]=GetPointData('InvLoadEstimation_Test_Results/Corrected_After_Reattachment/Single Corrected/scan_3_0.07V.svd','FFT','Ref2','Force','Real & Imag.',3,0);
...
for k=1:length(amp_levels)
    ...
    save(['InvLoadEstimation_Test_Results/Corrected_After_Reattachment/Double Correction Files/Higher Loads/DoubleAmpCorrection',num2str(k),'.txt'],'F_to_apply_normalized_final','-ascii');
...
for k=1:length(amp_levels)
    ...
    system(['copy /b preamble.txt+DoubleAmpCorrection',num2str(k),'.txt Correction_',num2str(k),'.txt']);
