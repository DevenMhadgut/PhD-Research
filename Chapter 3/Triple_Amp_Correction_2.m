...
for k=1:length(amp_levels)
    ...
    save(['InvLoadEstimation_Test_Results/Corrected_After_Reattachment/Triple Correction Files/Higher Loads/TripleAmpCorrection',num2str(k),'.txt'],'F_to_apply_normalized_final','-ascii');
